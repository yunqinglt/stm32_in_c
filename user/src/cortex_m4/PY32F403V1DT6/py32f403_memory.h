...
#define _AHB1               (_PY32_PERH + 0x18000)
...
#define SDIO_Base    (_AHB1 + 0x0)
#define DMA1_Base    (_AHB1 + 0x8000)
#define DMA2_Base    (_AHB1 + 0x8400)
// #define CORDIC_Base  (_AHB1 + 0xc00)
#define CRC_Base     (_AHB1 + 0x9000)
#define FMC_Base     (_AHB1 + 0xa000)
#define RCC_Base     (_AHB1 + 0xb000)
...
#define USART4_Base  (_APB1 + 0x4c00)
#define USART5_Base  (_APB1 + 0x5000)

#define I2C1_Base    (_APB1 + 0x5400)
#define I2C2_Base    (_APB1 + 0x5800)
#define USBD_Base    (_APB1 + 0x5c00)
#define USBDCAN_Base (_APB1 + 0x6000)
#define CAN_Base     (_APB1 + 0x6400)
