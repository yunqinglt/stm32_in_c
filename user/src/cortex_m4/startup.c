...
__ALIAS("Default_Handler") void MemManage_Handler(void);
__ALIAS("Default_Handler") void BusFault_Handler(void);
__ALIAS("Default_Handler") void UsageFault_Handler(void);
__ALIAS("Default_Handler") void DebugMon_Handler(void);
